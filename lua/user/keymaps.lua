...
map({ "n", "v", "o" }, "<Left>", "h", { remap = true })
map({ "n", "v", "o" }, "<Right>", "l", { remap = true })
map({ "n", "v", "o" }, "<Down>", "j", { remap = true })
map({ "n", "v", "o" }, "<Up>", "k", { remap = true })
map({ "n", "i", "v", "o", "t" }, "<C-Left>", "<C-h>", { remap = true })
map({ "n", "i", "v", "o", "t" }, "<C-Right>", "<C-l>", { remap = true })
map({ "n", "i", "c", "v", "o", "t" }, "<C-Down>", "<C-j>", { remap = true })
map({ "n", "i", "c", "v", "o", "t" }, "<C-Up>", "<C-k>", { remap = true })
map({ "n", "i", "v" }, "<A-S-Down>", "<A-j>", { remap = true })
map({ "n", "i", "v" }, "<A-S-Up>", "<A-k>", { remap = true })
...
-- gpt-5 suggestion, works pretty well
...
map({ "n", "i", "c", "v", "o", "t" }, "<C-k>", tmux.move_top, { desc = "Go to left window" })
map({ "n", "i", "c", "v", "o", "t" }, "<C-j>", tmux.move_bottom, { desc = "Go to left window" })
map({ "n", "i", "c", "v", "o", "t" }, "<C-h>", tmux.move_left, { desc = "Go to left window" })
map({ "n", "i", "c", "v", "o", "t" }, "<C-l>", tmux.move_right, { desc = "Go to left window" })
