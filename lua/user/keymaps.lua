...
-- Move to window using the <ctrl> arrow keys (for colemak)
...
map("n", "<C-Up>", tmux.move_top, {})
map("n", "<C-Down>", tmux.move_bottom, {})
map("n", "<C-Left>", tmux.move_left, {})
map("n", "<C-Right>", tmux.move_right, {})
map("i", "<C-Up>", tmux.move_top, {})
map("i", "<C-Down>", tmux.move_bottom, {})
map("i", "<C-Left>", tmux.move_left, {})
map("i", "<C-Right>", tmux.move_right, {})
map("v", "<C-Up>", tmux.move_top, {})
map("v", "<C-Down>", tmux.move_bottom, {})
map("v", "<C-Left>", tmux.move_left, {})
map("v", "<C-Right>", tmux.move_right, {})
map("t", "<C-Up>", tmux.move_top, {})
map("t", "<C-Down>", tmux.move_bottom, {})
map("t", "<C-Left>", tmux.move_left, {})
map("t", "<C-Right>", tmux.move_right, {})
...
map("c", "<C-Down>", 'pumvisible() ? "\\<C-n>" : "\\<C-Down>"', { expr = true, noremap = true })
map("c", "<C-Up>", 'pumvisible() ? "\\<C-p>" : "\\<C-Up>"', { expr = true, noremap = true })
